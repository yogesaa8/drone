...
const FAQ = () => {
  ...
  return (
    <section
      id="faq"
      className="relative py-24 lg:py-32 border-y border-border bg-charcoal/30"
    >
                ...
                <div key={i} className="border-b border-border last:border-b-0">
                  ...
                  >
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <span className="font-display text-base md:text-lg font-semibold wrap-break-word">
                        {f.q}
                      </span>
                    </div>
                    <span
                      className={`w-8 h-8 border border-border shrink-0 flex items-center justify-center text-tactical transition-transform ${
                        isOpen ? "rotate-45" : ""
                      }`}
                    >
                      +
